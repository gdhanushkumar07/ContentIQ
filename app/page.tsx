  ...
  return (
    <div className="pointer-events-none fixed inset-0 overflow-hidden z-0">
      ...
      <motion.div className="blob"
        ...
        animate={{ x:[0,-80,0], y:[0,60,0] }} transition={{ duration:18, repeat:Infinity, ease:'easeInOut', delay:2 }} />
      <motion.div className="blob"
        style={{ width:550, height:550, background:'radial-gradient(circle, rgba(56,189,248,0.08) 0%, transparent 70%)', bottom:-80, left:'42%' }}
        animate={{ x:[0,50,0], y:[0,-30,0] }} transition={{ duration:16, repeat:Infinity, ease:'easeInOut', delay:5 }} />
    </div>
  )
}
